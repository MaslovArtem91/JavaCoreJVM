public class JvmComprehension {
    ...
    public static void main(String[] args) {
        ...
        printAll(o, i, ii);             // 4 В Stack'е создается printAll
        // и в нем записываются переменные Object o, int i и Integer ii.
        System.out.println("finished"); // 7 В Stack'е создается println,
    ...
    private static void printAll(Object o, int i, Integer ii) {
        ...
        System.out.println(o.toString() + i + ii);  // 6 В Stack'е создается println,
        // куда передаются ссылки на Object o, int i и Integer ii. В Stack'е созается toString.
    }
}
